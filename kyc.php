...
<head>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/5.1.3/js/plugins/piexif.min.js"
            type="text/javascript"></script>
    <!-- sortable.min.js is only needed if you wish to sort / rearrange files in initial preview.
        This must be loaded before fileinput.min.js -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/5.1.3/js/plugins/sortable.min.js"
            type="text/javascript"></script>
            ...
            <nav class="sidebar-nav">
                <ul id="sidebarnav">
                    ...
                    <li class="sidebar-item"><a class="sidebar-link sidebar-link" href="card.php"
                                                aria-expanded="false"><i data-feather="credit-card"
                                                                         class="feather-icon"></i><span
                                            ...
                                            <div class="col-md-12 col-lg-9">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="passport-photo-container">
                                                        <input id="input-passport-photo" name="passport-photo[]"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="IC-photo-container">
                                                        <input id="input-IC-photo" name="IC-photo[]" type="file"
